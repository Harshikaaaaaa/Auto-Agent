        ...
        <div className="flex-1 flex min-h-0 overflow-hidden">
                ...
                return (
                  ...
                  >
                    <div className="flex items-start justify-between gap-2">
                      <span
                        className={`text-xs font-bold ${isSelected ? 'text-bolt-accent' : 'text-white'}`}
                      >
                        {approach.name}
                      </span>
                      {isSelected && (
          ...
          <div className="flex-1 flex flex-col min-w-0 bg-[#0c0c0c] overflow-hidden">
            ...
            <div className="p-5 border-b border-white/10 bg-[#0d0d0d] flex flex-col gap-3 shrink-0">
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <p className="text-xs text-white/60 mt-1">{currentExport.approach.description}</p>
                </div>
            ...
            <div className="px-6 py-3 border-t border-white/10 bg-[#0a0a0a] flex items-center justify-between text-xs text-white/40 shrink-0">
              <div>
                Target: <span className="text-white/80 font-medium">Python 3.10+</span> · Export:{' '}
                <span className="text-bolt-accent font-medium">ZIP Archive</span>
              </div>
              <div className="flex items-center gap-4">
                <span>{codeLines.length} lines of code</span>
                <span className="flex items-center gap-1">
                  <Archive className="w-3 h-3" /> + README + requirements.txt
                </span>
              </div>
            </div>
          </div>
