...
describe('deriveTaskNameFromPrompt', () => {
    it('title-cases the first few words', () => {
        expect(deriveTaskNameFromPrompt('send a summary email to the team')).toBe('Send A Summary Email To The');
    });
    ...
    it('clamps a long name with an ellipsis', () => {
        const name = deriveTaskNameFromPrompt('extraordinarily verbose descriptive workflow naming situation here');
